...
if (empty($_POST["email"])  OR empty($_POST["name"]) OR empty($_POST["password"]) OR empty($_POST["cnic"]) OR empty($_POST["language"])) {
...
print '</script>';
  ...
  //if valid then redirect
	   ...
	   $result = $db->exec("INSERT INTO sw_request(name,email,password,cnic,language) VALUES ( '$name' , '$email' , '$password' ,'$cnic','$lang')");
...
echo "		<h3 class=\"fs-subtitle\">Script Writer Registeration Form</h3>\n"; 
...
echo "		<input type=\"text\" name=\"language\" placeholder=\"Language\" />\n"; 
