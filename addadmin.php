...
if (empty($_POST["email"])  OR empty($_POST["name"]) OR empty($_POST["password"]) OR empty($_POST["contact"]) ) {
...
print '</script>';
     ...
     $result = $db->exec("INSERT INTO admin() VALUES (  '$name' , '$email'  , '$password'  , '$contact'  )");
...
echo "      <input type=\"contact\" class=\"form-control\" name=\"contact\" placeholder=\"Enter cell number here\">\n"; 
echo "    </div>\n"; 
echo "	\n"; 
echo "    \n"; 
echo "				\n"; 
