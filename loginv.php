...
if(isset($_SESSION["email"])) {
     header("Location: profilev.php"); // redirects them to homepage
...
$email = $_POST["email"] ;
$pass = $_POST["password"];
$stmt = $db->query("SELECT * FROM Verifier_login WHERE email= '$email' and password = '$pass'");
try {
...
print '		<meta charset="UTF-8" />';
	...
	print '	<meta name="viewport" content="width=device-width, initial-scale=1.0"> ';
       print ' <title>Problem Verifier Login</title>';
   ...
   print ' <body>';
       print ' <div class="container">';
		...
		print '	<header>
				...
				<h1>Problem Verifier <strong>Login Form</strong></h1>
...
<h1><span class="log-in">Log in</span> or <span class="sign-up">sign up</span></h1>
					...
					<p class="clearfix"> 
						<a href="registerv.php" class="log-twitter">New ?<strong> Register </strong></a>    
