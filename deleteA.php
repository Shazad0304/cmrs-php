  ...
  <div class="container-fluid">
    ...
    <div>
      ...
      <ul class="nav navbar-nav">
		...
		<li><a href="adminResponseUser.php">Response User </a></li>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="#">JavaScript</a></li>
		...
		<li class="dropdown">
				...
				<ul class="dropdown-menu">
                    <li><a href="DeleteLI.php" ><i class="fa fa-fw fa-user"></i> Language Identifier</a></li>
					...
					<li><a href="DeleteA.php" selected="selected"><i class="fa fa-fw fa-user"></i> Authority</a></li>
				</ul>
			</li>
		<li class="dropdown  pull-right">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="welcome.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </div>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <tr>
		...
		<td><button type="submit" class="btn btn-info">Delete</button>
	</td>
      </tr>
