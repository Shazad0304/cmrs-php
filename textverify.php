...
$stmt = $db->query("SELECT * FROM text_descriptive,text_message where id_text_message = id AND text_message.validity='0' ");
...
try {
	...
	{
	print '<form  method="POST" action = "yes1.php">';
	print '<tr>';
print '<td>'; 	echo $row['id_text_message'] ;     print '</td>';
