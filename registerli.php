...
if (empty($_POST["email"])  OR empty($_POST["name"]) OR empty($_POST["password"]) OR empty($_POST["cnic"])) {
...
print '</script>';
     ...
     $result = $db->exec("INSERT INTO request_li(email,name,password,cnic) VALUES ( '$email' , '$name' , '$password' ,'$cnic')");
...
echo "		<h3 class=\"fs-subtitle\">Language Identifier Registeration Form</h3>\n"; 
