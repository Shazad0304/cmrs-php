...
$text = 0;
$voice = 0;
$stmt = $db->query("SELECT * FROM text_descriptive where email_id= '$email'");
try {
...
$stmt1 = $db->query("SELECT * FROM message_descriptive where email_id= '$email'");
try {
...
print      '<li>';
print        '<a href="voicescriptwriter.php"><span ></span><i ></i> Voice Message Scipt</a>';
 print                       '</li>';
      print                  '<li class="divider"></li>';
         
		 print '  <li class="divider"></li>';
           print             '<li>';
      print                      '<a href="textscript.php"><span ></span><i ></i><strong> Text Message Script</strong></a>';
           print             '</li>';
		         print                  '<li class="divider"></li>';
				       print                  '<li class="divider"></li>';
		    print             '<li>';
