...
if($_SESSION["email_1"]) {
?>
Welcome <?php echo $_SESSION["email_1"]; ?>. Click here to <a href="logout.php" tite="Logout">Logout.
<?php
}
?>
</td>
...
print        '<a href="#"><span class="glyphicon glyphicon-user"></span><i class="fa fa-fw fa-user"></i> Profile</a>';
 print                       '</li>';
      print                  '<li class="divider"></li>';
           print             '<li>';
      print                      '<a href="logoutLI.php"><span class="glyphicon glyphicon-off"></span><i class="fa fa-fw fa-power-off"></i> Log Out</a>';
           print             '</li>';
print	'</li>';
print      '</ul>';
...
print '<h2>'; print 'Identify Language:'; print'</h2>';
...
print '<td>'; 	
*/
print '<form  method="POST" action = "language.php">';
...
print '<option value="Sindh">Sindhi</option>' ;
