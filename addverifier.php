...
if (empty($_POST["email"])  OR empty($_POST["name"]) OR empty($_POST["password"]) OR empty($_POST["cnic"]) OR empty($_POST['radio']) ) {
...
echo "if (confirm('Registered Successfully') == true) {
     window.location.href='addverifier.php' ;
    } else {
       window.location.href='addverifier.php' ;
    }";
...
echo "    </div>\n";
echo "<div class=\"form-group\">\n"; 
echo "      <label for=\"cnic\">CNIC:</label>\n"; 
echo "      <input type=\"cnic\" class=\"form-control\" name=\"cnic\" placeholder=\"Enter CNIC here\">\n"; 
echo "    </div>\n";

echo "      <label for=\"email\">Area:</label>\n"; 
print '<td>';
print '<div class="container1">';  print '&nbsp;';  
print '<input type="radio" name="radio" value="Urdu"><label>Badin</label>';
print '<br>';  print '<input type="radio" name="radio" value="Sindhi"><label>Karachi</label>';
print '<br>';  print '<input type="radio" name="radio" value="Punjabi"><label>Hyderabad </label>'; 
print '<br>';  print '<input type="radio" name="radio" value="Pishto"><label>Pishawer</label>';
print '<br>';  print '<input type="radio" name="radio" value="Balochi"><label>Islamabad</label>';
print '<br>';  print '<input type="radio" name="radio" value="Marwari"><label>Lahore </label>'; 
print '<br>';  print '<input type="radio" name="radio" value="English"><label>Faislabad</label>';
print '<br>';  print '<input type="radio" name="radio" value="Dhatki"><label>Multan</label>';
print '<br>';  print '<input type="radio" name="radio" value="Gujrati"><label>Sahiwal </label>'; 
print '<br>';  print '<input type="radio" name="radio" value="Gilgiti"><label>Mirpurkhas</label>';print '</div>'; print '</td>';
