...
if(isset($_SESSION["email_1"])) {
     header("Location: profileli.php"); // redirects them to homepage
...
$email = $_POST["email"] ;
$pass = $_POST["password"];
$stmt = $db->query("SELECT * FROM VOLUNTEER_SIGN_UP_1 WHERE email_1= '$email' and password_1 = '$pass'");
try {
	while($row = $stmt->fetch(PDO::FETCH_ASSOC)) 
{

$_SESSION["email_1"] = $row['email_1'];
$_SESSION["name_1"] = $row['password_1'];
}
...
if(isset($_SESSION["email_1"])) {
	$_SESSION['loginli'] = true;
header("Location:profileli.php");
}
else
{
...
print '		<meta charset="UTF-8" />';
	...
	print '	<meta name="viewport" content="width=device-width, initial-scale=1.0"> ';
       print ' <title>Language Identifier Login</title>';
   ...
   print ' <body>';
       print ' <div class="container">';
		...
		print '	<header>
				...
				<h1>Language Identifier <strong>Login Form</strong></h1>
...
<h1><span class="log-in">Log in</span> or <span class="sign-up">sign up</span></h1>
					...
					<p class="clearfix"> 
						<a href="registerli.php" class="log-twitter">New ?<strong> Register </strong></a>    
