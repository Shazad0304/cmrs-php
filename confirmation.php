...
print '</script>';
	   ...
	   $result1 = $db->prepare( "SELECT id_message
...
$result = $db->exec("INSERT INTO message_descriptive() VALUES ( '$user_id' , '$str' , '$desc2' ,'$email_2','$area','$cell_num')");
header("Location:voicescriptwriter.php");
  }
   }
?>