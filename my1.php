...
$mail->SMTPDebug  = 2; 
$mail->From = "arsalan.derani@gmail.com";
$mail->FromName = "Arsalan Derani";
...
$mail->SMTPAuth = true;
$mail->Username = "arsalan.derani@gmail.com"; // SMTP username
$mail->Password = "tpstps_123"; // SMTP password
$mail->AddAddress("shez.sting@gmail.com" , "Sumit Kumar"); //replace myname and mypassword to yours
...
$mail->Body = "The message description is  <br> ".$desc."" ;
