...
$stmt = $db->query("SELECT * FROM verifier_login ");
$table = "verifier_login";
print '<!DOCTYPE html>';
print '<html lang="en">';
print '<head>';
...
print '<td>'; print '&nbsp;'; echo   $row['email']; print '&nbsp;'; print '</td>';
print '&nbsp;';     
print '<td>'; print '&nbsp;'; echo   $row['cnic']; print '&nbsp;'; print '</td>';
print '&nbsp;';     
//$name = $row['name_1'];
$email =  $row['email'];
...
echo ' <INPUT TYPE=HIDDEN NAME= email value='.$email.'>';		
               print ' <td>';
			   print '<button type="sumit" class="btn btn-info">Delete</button>';
	print'</td>';
print '</tr>';
